...
void see(void)
{
                ...
                if(strcmpi(add.acc_type,"fixed1")==0)
                    {
                        ...
                        printf("\n\nYou will get BDT%.2f as interest on %d/%d/%d",intrst,add.deposit.day,add.deposit.month,add.deposit.year+1);
                    }
                else if(strcmpi(add.acc_type,"fixed2")==0)
                    {
                        ...
                        rate=11;
                        intrst=interest(time,add.amt,rate);
                        printf("\n\nYou will get BDT.%.2f as interest on %d/%d/%d",intrst,add.deposit.day,add.deposit.month,add.deposit.year+2);
                ...
                else if(strcmpi(add.acc_type,"fixed3")==0)
                    {
                        ...
                        rate=13;
                        intrst=interest(time,add.amt,rate);
                        printf("\n\nYou will get BDT.%.2f as interest on %d/%d/%d",intrst,add.deposit.day,add.deposit.month,add.deposit.year+3);
    ...
    {   printf("Enter the name:");
        scanf("%s",&check.name);
        while (fscanf(ptr,"%d %s %d/%d/%d %d %s %s %s %s %f %d/%d/%d",&add.acc_no,add.name,&add.dob.month,&add.dob.day,&add.dob.year,&add.age,add.address,add.citizenship,add.phone,add.acc_type,&add.amt,&add.deposit.day,&add.deposit.month,&add.deposit.year)!=EOF)
        {
...
void close(void)
{
    printf("\n\n\n\nThis C Mini Project is developed by AKHTAR SPONDON!");
    }
...
int main()
{
    char pass[10],password[10]="akhtar";
    int i=0;
